...
password: {
    ...
    message: props => `${props.value} n'est pas un mot de passe valide! Le mot de passe doit contenir au moins une lettre minuscule,
    une lettre majuscule, un chiffre, doit avoir au moins 8 caractères et doit contenir au moins un caractère spécial !@#$%^&*(),.?":{}|.`
         }
        },
    isAdmin: {
        type: Boolean,
